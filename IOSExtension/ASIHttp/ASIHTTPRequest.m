...
- (void)requestFinished
{
	...
	if ([self isPACFileRequest] || !delegate || [delegate respondsToSelector:@selector(reportFinished)]) {
		[self reportFinished];
	} else {
...
- (void)failWithError:(NSError *)theError
{
	...
	if ([self isPACFileRequest] || !delegate || [delegate respondsToSelector:@selector(reportFailure)]) {
